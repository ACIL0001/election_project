...
export default function LoadingScreen() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md transition-all">
      <div className="flex flex-col items-center gap-6 p-8 rounded-3xl border border-zinc-200/50 dark:border-white/10 bg-white/70 dark:bg-zinc-900/70 shadow-2xl backdrop-blur-xl w-[calc(100%-2rem)] max-w-[360px] text-center relative overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <img
            src="/icon.png"
            alt="PVP Logo"
            className="w-24 h-24 object-contain relative z-10 animate-bounce duration-[2000ms]"
          />
        </div>
